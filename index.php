...
<div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
        <h1 class="page-banner__title">The Archive News</h1>
        <div class="page-banner__intro">
            <p style="color: white;">Keep up with the news.</p>
        </div>
    </div>
</div>
...
<div class="container container--narrow page-section">
    ...
    <div class="post_item">
        ...
        <div class="metabox">
            <p>Posted By <?php the_author_posts_link(); ?> on <?php the_time('j.n.y'); ?></p>
